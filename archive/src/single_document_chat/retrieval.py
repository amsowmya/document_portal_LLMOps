...
class ConversationalRAG:
    ...
    def _load_llm(self):
        try:
            ...
            self.log.info("Error loading LLM via ModelLoader", error=str(e))
            raise DocumentPortalException("Failed to load LLM", sys)
        
    def _get_session_history(self, session_id: sys):
        try:
            ...
            self.log.info("Failed to access session history", session_id=session_id, error=str(e))
    ...
    def load_retriever_from_faiss(self, index_path: str):
        try:
            ...
            self.log.info("Failed to load retriever from FAISS", error=str(e))
    ...
    def invoke(self, user_input: str) -> str:
        try:
            ...
            self.log.info("Failed to invoke Conversational RAG", error=str(e))
