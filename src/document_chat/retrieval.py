...
class ConversationalRAG:
    ...
    def invoke(self, user_input: str, chat_history: Optional[List[BaseMessage]] = None) -> str:
        try:
            ...
            self.log.error("Failed to incoke ConversationalRAG", error=str(e))
    ...
    def _build_lcel_chain(self):
        try:
            ...
            self.log.error("Failed to built LCEL chain", error=str(e))
            raise DocumentPortalException("Failed to built LCEL chain", sys)